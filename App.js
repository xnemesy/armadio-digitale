...
// Polyfill semplice per Blob (necessario per Firebase Storage)
if (Platform.OS !== 'web' && typeof global.Blob === 'undefined') {
...
export default function App() {
  ...
  const handleUploadImage = async () => {
    try {
      ...
      // Usa uploadString con formato 'raw' (più semplice per React Native)
      const demoText = "Demo foto caricata da React Native - Firebase Storage funzionante!";
