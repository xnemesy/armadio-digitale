...
// Extracted screens (modularized)
import ImportedAddItemScreen from './src/screens/AddItemScreen';
import ImportedDetailScreen from './src/screens/DetailScreen';
import ImportedOutfitBuilderScreen from './src/screens/OutfitBuilderScreen';
import ImportedStatsScreen from './src/screens/StatsScreen';
import ImportedProfileScreen from './src/screens/ProfileScreen';
import ImportedHomeScreen from './src/screens/HomeScreen';
import ImportedAuthScreen from './src/screens/AuthScreen';
import { APP_ID, APP_ID } from './src/config/appConfig';
...
const APP_ID = typeof APP_ID !== 'undefined' ? APP_ID : 'armadio-digitale-demo'; 
...
const OutfitBuilderScreen = ({ navigation, route }) => {
    ...
    useEffect(() => {
        ...
        const itemsCollectionPath = `artifacts/${APP_ID}/users/${user.uid}/items`;
...
const HomeStackNavigator = ({ user }) => (
    ...
    >
        <Stack.Screen 
            name="HomeMain" 
            component={ImportedHomeScreen}
            initialParams={{ user }}
        />
        <Stack.Screen 
            name="Detail" 
            component={ImportedDetailScreen}
            options={{
                animation: 'default',
                presentation: 'card',
                gestureEnabled: true,
...
const OutfitAIStackNavigator = ({ user }) => (
    ...
    >
        <Stack.Screen 
            ...
            component={ImportedOutfitBuilderScreen}
            initialParams={{ user }}
        />
    </Stack.Navigator>
);
...
const ProfileStackNavigator = ({ user }) => (
    ...
    >
        <Stack.Screen 
            name="ProfileMain" 
            component={ImportedProfileScreen}
            initialParams={{ user }}
        />
    </Stack.Navigator>
);
...
const MainTabNavigator = ({ user }) => (
    ...
    >
        ...
        <Tab.Screen 
            name="AddItem" 
            component={ImportedAddItemScreen}
            initialParams={{ user }}
            options={{ 
                tabBarLabel: '',
